...
public class ReporteController {
    ...
    //Para tener acceso a la conexion con la base de datos...
    @Autowired
    ...
    public ResponseEntity<Resource> reporteClientes(@RequestParam String tipo) throws IOException {
        //Por desarrollar
        //Se usa para definir los parametros que se pasan al reporte de Cliente
        Map<String, Object> parametros = new HashMap();
        parametros.put("titulo", "Steven");
    ...
    @GetMapping("/facturar")
    public ResponseEntity<Resource> reporteFacturar(@RequestParam String tipo) throws IOException {
        //Por desarrollar
        var reporte = "Factura";
        Map<String, Object> parametro = new HashMap();
        parametro.put("facturaId", 1);
        return reportePrivado(reporte, null, tipo);
    }
    ...
    private ResponseEntity<Resource> reportePrivado(String reporte, Map<String, Object> parametros, String tipo) throws IOException {
        ...
        try {
            ...
            //En salida quedara el reporte ya generado
